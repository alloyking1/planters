                ...
                <x-blog.components.card title="Edit Post" subtitle="Use the form below to edit post..">
                    <form
                        ...
                        <div x-data="{
                            ...
                            <div class="mt-4">
                                <x-text-input id="title" placeholder="title" class="block mt-1 w-full" type="text" name="title" x-model="postTitle" :value="old('title', $postValue->title ?? '' )" required autofocus autocomplete="title" />
